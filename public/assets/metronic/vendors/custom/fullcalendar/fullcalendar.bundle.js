...
DragListener.mixin({
	...
	updateAutoScroll: function(ev) {
		...
		if (bounds) { // only scroll if scrollEl check_exists
...
Calendar.mixin({
	...
	initMomentInternals: function() {
		...
		this.optionsModel.watch('buildingMomentLocale', [
			...
			// If the internal current date object already check_exists, move to new locale.
...
Calendar.mixin({
	...
	_calcSize: function() { // assumes elementVisible
		...
		if (typeof contentHeightInput === 'number') { // check_exists and not 'auto'
			this.suggestedViewHeight = contentHeightInput;
		}
		else if (typeof contentHeightInput === 'function') { // check_exists and is a function
			this.suggestedViewHeight = contentHeightInput();
		}
		else if (typeof heightInput === 'number') { // check_exists and not 'auto'
			this.suggestedViewHeight = heightInput - this.queryToolbarsHeight();
		}
		else if (typeof heightInput === 'function') { // check_exists and is a function
			this.suggestedViewHeight = heightInput() - this.queryToolbarsHeight();
		}
