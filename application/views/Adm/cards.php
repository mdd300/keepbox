...
<head>
  ...
  <title>SB Admin - Start Bootstrap Template</title>
    ...
    <link href="<?=base_url()?>public/assets/metronic/vendors/jquery/cropper.min.css" rel="stylesheet">
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top" ng-controller="prod_adm_ctrl">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
          <a class="nav-link" href="easypost.php">
  ...
  <div class="content-wrapper" style="    margin-top: 130px;">
    <div class="container-fluid">
        <div class="card mb-3">
            ...
            <div class="form-group p-2">
                ...
                <div class="col-md-4">
                    <div class="autocomplete">
                        <input id="user" ng-model="produto.user" name="user" type="text" placeholder="Cliente" class="form-control input-md" required="">
                    </div>
                </div>
            </div>
            ...
            <div class="form-group p-2">
                ...
                <div class="col-md-4">
                    <input id="Nome" name="Nome" ng-model="produto.nomeProd" type="text" placeholder="Nome" class="form-control input-md" required="">
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <script src="<?=base_url()?>public/assets/metronic/vendors/bootstrap/Chart.min.js"></script>
      ...
      <script src="<?=base_url()?>public/assets/metronic/vendors/jquery/cropper.min.js"></script>
